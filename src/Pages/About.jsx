          ...
          <div className={styles.content_info}>
            <div className={styles.info_text}>
              ...
              <p className={styles.sub_title}>
                I am looking for exciting opportunities. Has Computer Science
                background. Likes to focus on accessibility when developing.
                Passionate and curious about solving problems & learning about
                real-estate. Currently, I’m exploring Reactjs, Webflow and a bit
                of Designing. While I am not programming, I enjoy playing
                football, spending time with my friends & family and staying
                indoor. Learning more to improve skill
              </p>
            </div>
            ...
            {experiences.map((experience, index) => (
              <div key={index} className={styles.exp_content_info}>
                <div className={styles.info_top_layer}>
                  ...
                  <p className={styles.company}> <a href="https://www.motormata.com">{experience.company}</a> </p>
                </div>
