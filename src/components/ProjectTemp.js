...
function ProjectTemp({ liveUrl, githubUrl, projectImage, title, description,year,role,name }) {
  return (
    <section className={styles.template}>
      <div className={styles.temp_header}>
        <p className={styles.proj_name}>
        {name}
        </p>
        <div className={styles.proj_img}>{projectImage}</div>
      </div>
          ...
          <div className={styles.bottom_layer}>
            ...
            <div className={styles.info_details}>
              ...
              <p className={styles.detail}>
                <span className={styles.topic}>Year</span>{" "}
                <span className={styles.value}>{year}</span>
              </p>
              <hr />
              <p className={styles.detail}>
                <span className={styles.topic}>Role</span>{" "}
                <span className={styles.value}>Front-end</span>
              </p>
              <hr />
            </div>
          </div>
